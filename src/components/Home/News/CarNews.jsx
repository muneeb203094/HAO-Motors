...
const CarNews = () => {
  const newsData = [
    ...
    },
    {
      ...
      desc: "BMW Group USA clocks best-ever annual sales in 2023, leads luxury electric car segment",
    },
    {
      id: 2,
      img: "/src/assets/img/news3.jpg",
      desc: "MG Astor 2024 launched in Pakistan, price starts at Rs 50 lakh",
    },
    {
      id: 3,
      img: "/src/assets/img/news4.jpg",
      desc: "Kia Sonet facelift launched in Pakistan at Rs 50 lakh, Nexon &  Suzuki Brezza rival",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      desc: "JLR Canada sales rise 74% in Q3 on robust demand for Range Rover, Range Rover Velar, Defender",
    },
  ];
